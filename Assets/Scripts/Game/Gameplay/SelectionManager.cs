...
public class SelectionManager : Singleton<SelectionManager>
{
    ...
    void ExecuteMove(Piece piece, Vector2Int targetPos)
    {
        ...
        // 🔥 STORE FROM / TO TILE (NEW)
        Tile fromTile = BoardManager.Instance.GetTileAt(startPos.x, startPos.y);
        Tile toTile = BoardManager.Instance.GetTileAt(targetPos.x, targetPos.y);
